    ...
    def self.attribute_definitions
      [
        ...
        { attribute: :admission_year,    label: "Admission Year",    required: true,
          aliases: %w[admission_year ปีที่รับเข้า] },
        ...
        { attribute: :program_name,      label: "Program",           required: false,
          aliases: %w[program program_name หลักสูตร],
