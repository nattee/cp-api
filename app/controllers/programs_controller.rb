class ProgramsController < ApplicationController
  ...
  def program_params
    params.require(:program).permit(:program_code, :alternative_program_code, :short_name, :name_en, :name_th, :degree_level, :degree_name, :degree_name_th, :field_of_study, :year_started, :active, :total_credit)
  end
end
