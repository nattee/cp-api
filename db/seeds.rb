...
if Rails.env.development?
  ...
  [
    ...
    { student_id: "6732100039", first_name: "Siriporn",  last_name: "Jantaraksa",   first_name_th: "ศิริพร",   last_name_th: "จันทรักษา",  admission_year_be: 2567, email: "siriporn.j@student.chula.ac.th", line_id: "siriporn_j",    previous_school: "Mahidol Wittayanusorn", enrollment_method: "TCAS Round 1", program: cp_bachelor },
    { student_id: "6732100047", first_name: "Natthaphon", last_name: "Kaewmanee",   first_name_th: "ณัฐพล",    last_name_th: "แก้วมณี",    admission_year_be: 2567, email: "natthaphon.k@student.chula.ac.th", phone: "081-234-5678", guardian_name: "Somchai Kaewmanee", guardian_phone: "089-876-5432", previous_school: "Suankularb Wittayalai", enrollment_method: "TCAS Round 3", program: cp_bachelor },
    { student_id: "6632100055", first_name: "Ploypailin", last_name: "Wongprasert",  first_name_th: "พลอยไพลิน", last_name_th: "วงศ์ประเสริฐ", admission_year_be: 2566, email: "ploypailin.w@student.chula.ac.th", discord: "ploy_w#5678", previous_school: "Kasetsart University Laboratory School", enrollment_method: "TCAS Round 2", program: cp_bachelor },
    { student_id: "6632100063", first_name: "Kittipat",  last_name: "Thongkham",    first_name_th: "กิตติพัฒน์", last_name_th: "ทองคำ",      admission_year_be: 2566, status: "on_leave", email: "kittipat.t@student.chula.ac.th", program: cp_bachelor },
    { student_id: "6532100071", first_name: "Arunee",    last_name: "Phanomwan",    first_name_th: "อรุณี",    last_name_th: "พนมวัน",     admission_year_be: 2565, status: "graduated", email: "arunee.p@student.chula.ac.th", previous_school: "Chulalongkorn University Demonstration School", enrollment_method: "Direct Admission", program: cp_bachelor },
  ].each do |attrs|
